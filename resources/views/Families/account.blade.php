          ...
          <div class="card">
           ...
           {{$family[0]['FamilyName']}} - Account
            ...
            <div class="col-md-12 float-right ">
                  <button class="btn btn-info btn-md float-right m-2 " data-toggle="modal" data-target="#myModal" id="Add" >Add Donation</button>
                  </div>
                  </div>
                  <div class="row">
                  <div class="col-sm-12 mb-4">
                       ...
                       <div class="table-responsive overflow-x-scroll overflow-y-hidden">
                           <table class="table table-bordered table-striped" id="accounttable">
                               <thead class="thead-light">
                                   ...
                                   <th class="text-left border-right-0 border-bottom-0">Date</th>
                                           <th class="text-left border-right-0 border-bottom-0">Sponsor</th>
                                           <th class="text-left border-right-0 border-bottom-0">Member</th>

                                           <th class="text-center border-right-0 border-bottom-0 w-10">Type</th>
                                           <th class="text-center border-right-0 border-bottom-0 w-10">Notes</th>
                           ...
                           <?php $total+= $mainaccount->cAmount;?>
                                    <tr>
        <td>{{Carbon\Carbon::parse($mainaccount->Date)->format('Y-m-d')}}</td>
          <td align='center'> {{$mainaccount->sponsorN}}</td>
          <td align='center'> {{$mainaccount->familymember}}</td>
          <td align='center'>{{$mainaccount->Type}}</td> 
            <td align='center'>{{$mainaccount->Notes}}</td> 
          <td align='center'> {{$mainaccount->symbol}}</option></td>
          
          <td align='center'>{{$mainaccount->Amount}}</td> 
          ...
          <a href="{{ route('families.cheque', $mainaccount->id) }}" target="_blank" class="btn btn-primary btn-sm m-1"><span class="fas fa-print"></span></a>
